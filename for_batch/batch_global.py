...
def batch(dbDir,dbName,dbExtens,scriptref,nproc):
    ...
    cmd='python {}.py --dbDir {} --dbName {} --dbExtens {} --nproc {}'.format(scriptref,dbDir,dbName,nproc,dbExtens)
    script.write(cmd+" \n")
    script.write("EOF" + "\n")
    script.close()
...
dbNames = ['baseline_2snap_v1.3_10yrs','baseline_v1.3_10yrs','baseline_nomix_v1.3_10yrs','agnddf_illum60_v1.3_10yrs','agnddf_illum30_v1.3_10yrs','agnddf_illum10_v1.3_10yrs','agnddf_illum15_v1.3_10yrs','descddf_illum60_v1.3_10yrs','descddf_illum30_v1.3_10yrs','descddf_illum7_v1.3_10yrs','descddf_illum15_v1.3_10yrs','descddf_illum10_v1.3_10yrs','descddf_illum3_v1.3_10yrs','euclid_ddf_v1.3_10yrs','descddf_illum4_v1.3_10yrs','descddf_illum5_v1.3_10yrs','euclid_ddf_v1.3_10yrs']
