...
python run_scripts/telescope/zero_points_atmos.py --nproc=16 --airmass_step=0.05 --sigma_airmass_min=0.001 --sigma_airmass_max=0.012 --sigma_airmass_step=0.001  --outName=zp_atmos_airmass.hdf5
