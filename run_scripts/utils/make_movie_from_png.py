...
parser.add_option("--outName", type="str", default='movie',
                  help="output name for the movie [%default]")
...
cmd = 'ffmpeg -v verbose -framerate {} -s 1920x1080 -f image2 -i {}/{}_%03d.{} -vcodec libx264 -crf 10 -pix_fmt yuv420p {}/{}.mp4 -y'.format(
    rate, figDir, prefix, extens, movDir, outName)
