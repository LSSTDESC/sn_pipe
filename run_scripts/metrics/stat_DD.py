...
import pandas as pd
from sn_tools.sn_cadence_tools import Stat_DD
import astropy
import h5py
import warnings
...
outName = 'Summary_DD.hdf5'
file_data = h5py.File('{}'.format(outName), 'w')

for i, vv in toprocess.iterrows():
    restab = Stat_DD(vv['dbDir'], vv['dbName'], vv['dbExtens']).summary
